...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-xxl py-5">
        <div class="container px-lg-5">
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid wow zoomIn" data-wow-delay="0.5s" src="<?php echo e(asset('assets/img/about.jpg')); ?>">
                </div>
            </div>
        </div>
    </div> 
    ...
    <?php echo $__env->make('components.items.contact-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('components.items.faq', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 
<?php $__env->stopSection(); ?>
<?php echo $__env->make('components.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/lenovo/SSD2/new/succu/ecom/resources/views/pages/index.blade.php ENDPATH**/ ?>