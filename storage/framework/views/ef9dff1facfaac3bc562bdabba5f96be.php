                ...
                <div class="card">
                    <div class="card-body">                
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="productName" name="productName" value="<?php echo e($product->name); ?>" placeholder="Enter Product Name ...">
                            <input type="hidden" class="form-control" id="productId" name="productId" value="<?php echo e($product->id); ?>" >
                        </div>
                        <div class="form-group">
                            <label for="pageTitle">Slug</label>
                            <input type="text" class="form-control" id="productSlug" name="productSlug" value="<?php echo e($product->slug); ?>" oninput="validateSlug(this)" placeholder="Enter Page Title ...">
                        </div>
                        <div class="form-group">
                            <label for="attributeUnit">Short Desctiption</label>
                            <textarea class="form-control" rows="4" style="    height: 75px;" id="shortDesc" name="shortDesc"><?php echo e($product->short_Desc); ?></textarea>
                        </div>
                        <div class="form-group">
                            <label for="attributeUnit">Desctiption</label>
                            <textarea class="form-control" rows="4" style="    height: 75px;" id="desc" name="desc"><?php echo $product->desc; ?></textarea>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">                
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="metaTitle" value="<?php echo e($product->meta_title); ?>" name="metaTitle" placeholder="Enter Category Name ...">
                            </div>
                            <div class="form-group">
                                <label for="metaDesc">Meta Desctiption</label>
                                <textarea class="form-control" rows="4" style="    height: 75px;" id="metaDesc" name="metaDesc"><?php echo e($product->meta_desc); ?></textarea>
                            </div>
                            <div class="d-flex justify-content-evenly">
                                <div class="form-group">
                                    <label for="is_featured">Is Featured?</label>
                                    <input type="checkbox" id="is_featured" name="is_featured" <?php echo e($product->is_featured ? 'checked' : ''); ?>>
                                </div>
                                <div class="form-group">
                                    <label for="is_flash_sale">Is Flash Sales?</label>
                                    <input type="checkbox" id="is_flash_sale" name="is_flash_sale" <?php echo e($product->is_flash_sale ? 'checked' : ''); ?>>
                                </div>
                                <div class="form-group">
                                    <label for="is_active">Is Active?</label>
                                    <input type="checkbox" id="is_active" name="is_active" <?php echo e($product->is_active ? 'checked' : ''); ?>>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="featured_image">Featured Image</label>
                                <input type="file" id="featured_image" name="featured_image" class="form-controller">
                                <img id="imagePreview" src=" <?php echo e(asset('images/products/' . $product->featured_img)); ?> " alt="Image Preview" style="    display: block;    width: 100%;height: auto;margin-top: 10px;">
                            </div>
...
$(document).ready(function(){
  ...
  function getSubCategory(id) {
    $.ajax({
        url: '<?php echo e(route("sub-category.get", ":id")); ?>'.replace(':id', id),
        type: 'GET',
        // contentType: false,
        // processData: false,
        success: function(response) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/lenovo/SSD2/new/succu/ecommerce-V2/resources/views/admin/product/edit.blade.php ENDPATH**/ ?>