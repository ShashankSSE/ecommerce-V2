  ...
  <body>
                ...
                <div class="main-logo">
                  <a href="/">
                    <?php if($settings->header_logo): ?>
                      <img src="<?php echo e(asset('images/site/' . $settings->header_logo)); ?>" alt="logo">
                    <?php else: ?>
                      <h2>Succu</h2>
                    <?php endif; ?>
                  </a>
                    ...
                    <ul class="menu-list">
                      ...
                      <li class="menu-item has-sub">
                        ...
                        <ul class="submenu">
                          ...
                          <li class="menu-item has-sub">
                            <a href="<?php echo e(route('frontend.category.index', ['slug' => $category->slug])); ?>" class="item-anchor d-flex align-item-center justify-content-between"><?php echo e($category->name); ?> <?php echo count($category->subcategories) > 0 ? '<i class="icon icon-chevron-right"></i>' : ''; ?></a>
                            <?php if(count($category->subcategories) > 0): ?>
                            <ul class="submenu">
                              <?php $__currentLoopData = $category->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php if($subcategory->slug): ?>
                              <li>
                                  <a href="<?php echo e(route('frontend.subcategory.index', ['slug' => $subcategory->slug])); ?>" class="item-anchor">
          ...
          <div class="row d-flex flex-wrap justify-content-between">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="footer-menu">
                ...
                <p>Do you have any questions or suggestions? <?php echo $settings->email ? '<a href="mailto:' . $settings->email . '" class="email">' . $settings->email . '</a>' : ''; ?>

                </p>
                <p>Do you need assistance? Give us a call. <br>
                <?php echo $settings->mobile ? '<a href="tel:' . $settings->mobile . '" class="email">+91-' . $settings->mobile . '</a>' : ''; ?>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="footer-menu">
                ...
                <p><?php echo e($settings->short_description); ?></p>
                <div class="social-links">
                  <ul class="d-flex list-unstyled">
                  <?php $__currentLoopData = json_decode($settings->social_media); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social=>$url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
      function addToCart(id){
        $.ajax({
            url: "<?php echo e(route('cart.addToCart', ['id' => ':id'])); ?>".replace(':id', id),
