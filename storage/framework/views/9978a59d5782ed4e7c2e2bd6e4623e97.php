<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
        ...
        <ul class="navbar-nav ms-auto">    
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              ...
              <a href="<?php echo e(route('user.edit',['id' => auth()->user()->id])); ?>" class="dropdown-item"><i class="dropdown-item-icon mdi mdi-account-outline text-primary me-2"></i> My Profile</a>
    ...
    </nav><?php /**PATH /media/lenovo/SSD2/new/succu/ecommerce-V2/resources/views/layouts/navigation.blade.php ENDPATH**/ ?>