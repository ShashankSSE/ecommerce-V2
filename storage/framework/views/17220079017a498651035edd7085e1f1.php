...
<div class=" py-5  bg-primary hero-header mb-5" id="hero-header">
    <div class=" my-5  px-lg-5">
        <div class="row my-5 ">
            ...
            <div class="col-lg-6 text-center text-lg-start">
                <img class="img-fluid" src="<?php echo e(asset('assets/img/hero-bg.jpg')); ?>" alt="">
            </div>
        </div>
    </div>
</div>
            ...
            <div class=" px-lg-5">
                <div class="row align-items-center" style="height: 250px;">
                    ...
                    <div class="col-md-6 text-center mb-n5 d-none d-md-block">
                        <img class="img-fluid" style="height: 250px;" src="<?php echo e(asset('assets/img/newsletter.png')); ?>">
                    </div>
                </div>
            </div>
        </div>
...
</html><?php /**PATH /media/lenovo/SSD2/new/succu/ecom/resources/views/components/app.blade.php ENDPATH**/ ?>