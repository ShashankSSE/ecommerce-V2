...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="user">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('user.index')); ?>">Users</a></li>
      ...
      <!-- partial --><?php /**PATH /media/lenovo/SSD2/new/succu/ecommerce-V2/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>