            ...
            <div class="card-body">
                ...
                <form class="forms-sample" id="updateSettingsForm">
                    ...
                    <div class="form-group">
                        ...
                        <img id="headerLogoPreview" src="<?php echo e($settings->header_logo !== 'default_logo.png' ? asset('images/site/' . $settings->header_logo) : asset('images/site/no-img.png')); ?>" alt="Image Preview" style="    display: block;        width: 100px;height: 100px; auto;margin-top: 10px;">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <img id="footerLogoPreview" src="<?php echo e($settings->footer_logo !== 'default_footer_logo.png' ? asset('images/site/' . $settings->footer_logo) : asset('images/site/no-img.png')); ?>" alt="Image Preview" style="    display: block;        width: 100px;height: 100px; auto;margin-top: 10px;">
                    </div>
                    <div class="form-group">
                        ...
                        <img id="faviconPreview" src="<?php echo e($settings->favicon !== 'default_favicon.png' ? asset('images/site/' . $settings->favicon) : asset('images/site/no-img.png')); ?>" alt="Image Preview" style="    display: block;        width: 100px;height: 100px; auto;margin-top: 10px;">
                    </div>
                    
                    <div class="form-group">
                        <label for="pageDesctiption">Mobile</label>
                        <div style="width: 50%;">
                            <input style="width:100%;" type="number" class="form-control" value="<?php echo e($settings->mobile); ?>" id="mobile" name="mobile" value="" placeholder="Enter Mobile ...">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="pageDesctiption">Email</label>
                        <div style="width: 50%;">
                            <input style="width:100%;" type="email" class="form-control" value="<?php echo e($settings->email); ?>" id="email" name="email" value="" placeholder="Enter Email ...">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="pageDesctiption">Address</label>
                        <textarea class="form-control" id="address" name="address"> <?php echo e($settings->address); ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="pageDesctiption">Meta Title</label>
                        <input type="text" class="form-control" id="metaTitle" value="<?php echo e($settings->meta_title); ?>" name="metaTitle" value="" placeholder="Enter Meta Title ...">
                    </div>
                    <div class="form-group">
                        <label for="pageDesctiption">Meta Keyword</label>
                        <div style="width: 50%;">
                            <p style="color:red">For multiple keyword please add comma (,) and proceed</p>
                            <input style="width:100%;" type="text" class="form-control" value="<?php echo e($settings->meta_keyword); ?>" id="metaKey" name="metaKey" value="" placeholder="Enter Meta Keys ... eg. key1,key2...">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="pageDesctiption">Short Desctiption</label>
                        <textarea class="form-control" id="desc" name="desc"><?php echo e($settings->short_description); ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="pageDesctiption">Meta Description</label>
                        <textarea class="form-control" id="metaDesc" name="metaDesc"><?php echo e($settings->meta_description); ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="pageDesctiption">Credits</label>
                        <input type="text" class="form-control" id="creadits" value="<?php echo e($settings->credits); ?>" name="creadits" value="" placeholder="Enter Credits ...">
                    </div>
                    <div class="form-group">
...
<script>
    ...
    $(document).ready(function(){
        var socials = <?php echo json_encode($settings, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/lenovo/SSD2/new/succu/ecommerce-V2/resources/views/admin/settings/index.blade.php ENDPATH**/ ?>