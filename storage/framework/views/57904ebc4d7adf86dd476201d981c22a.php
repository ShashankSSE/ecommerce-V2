...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('assets/admin/richtexteditor/rte_theme_default.css')); ?>" />
  <link rel="stylesheet" href="<?php echo e(asset('assets/admin/css/custom.css')); ?>" />
  <script type="text/javascript" src="<?php echo e(asset('assets/admin/richtexteditor/rte.js')); ?>"></script>
  <script type="text/javascript" src="<?php echo e(asset('assets/admin/richtexteditor/plugins/all_plugins.js')); ?>"></script>
...
<div class="container-scroller"> 
  ...
  <script src="<?php echo e(asset('assets/admin/js/table.js')); ?>"></script>
...
<?php /**PATH /media/lenovo/SSD2/new/succu/ecommerce-V2/resources/views/layouts/app.blade.php ENDPATH**/ ?>