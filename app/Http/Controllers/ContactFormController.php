...
class ContactFormController extends Controller
{
    ...
    { 
        ...
        try {
            Mail::to('business@99mentor.com')->send(new ContactFormMail($data));
    ...
    { 
        ...
        try {
            Mail::to('business@99mentor.com')->send(new BookDemoMail($data));
    ...
    { 
        ...
        $currentDateTime = now();
        $modifiedDateTime = $currentDateTime->addHours(5)->addMinutes(30);
        $broucher_url = asset('assets/img/broucher-99mentor.pdf'); 
        // Format the modified date and time
        $formattedDateTime = $modifiedDateTime->format('d-m-Y h:i:s A');
        $data = array(
            'Name' => $name,
