      ...
      <tbody>
        <tr>
          <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 0;" width="596">
            <h1 style="font-size: 20px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 600; text-decoration: none; color: #000000; margin-bottom: 0;">Dear {{ $data['Name'] }},</h1>
      ...
      <tbody>
        <tr>
          <td style="width: 500px; vertical-align: top; padding-left: 30px; padding-right: 15px; padding-top: 0; padding-bottom: 30px; text-align: center;" width="252">
            ...
            <p style="font-size: 15px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #919293;">Thank you for showing your interest in <strong>99Mentor’s </strong> product & services. Our expert will coordinate with you within 24 hours for the detailed information.<br>Want more information about 99Mentor?<br>Check out our  portal <a href="http://127.0.0.1:8000/" target="_blank">99mentor</a>.</p>
