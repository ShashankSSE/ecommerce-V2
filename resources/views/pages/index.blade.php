...
<section id="billboard" class="overflow-hidden">
      ...
      <div class="swiper main-swiper">
        <div class="swiper-wrapper">
          <div class="swiper-slide" style="background-image: url('{{asset('assets/frontend/images/banner1.jpg')}}');background-repeat: no-repeat;background-size: cover;background-position: center;">
          ...
          <div class="swiper-slide" style="background-image: url('{{asset('assets/frontend/images/banner2.jpg')}}');background-repeat: no-repeat;background-size: cover;background-position: center;">
            <div class="banner-content">
              <div class="container">
                <div class="row">
                  <div class="col-md-6">
