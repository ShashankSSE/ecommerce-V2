...
@section('title', 'Patakha | Services')
                    ...
                    <div id="lms" class="col-lg-12 col-md-12 portfolio-item first wow zoomIn" data-wow-delay="0.1s" style="    margin-top: 70px;border-bottom: 2px solid #cccccc8f; padding-bottom:50px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5 text">                                
                                <p>With our LMS, educational institutes can improve student engagement, enhance learning outcomes, and optimize their operations. Join the future of education with Patakha.</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-7">
                                ...
                                <div class="accordion"> 
                                    <div class="accordion-item">
                                        ...
                                        <div class="accordion-item-desc">Patakha play a crucial role in product development. We guide the development team, ensuring the creation of robust, scalable, and innovative products that meet your business needs and market demands.</div>
                                    </div>
