                ...
                <div class="row g-5">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="section-title position-relative mb-4 pb-2">
                            ...
                            <h2 class="mt-2">Empowering Growth Through Innovation: <span style="color:#fc861b;">Unveiling the Journey Patakha</span></h2>
                        </div>
                        <p class="mb-4">Patakha, a leading India- based startup with over a decade of experience in software development and AI-based programs. At Patakha, we are committed to delivering innovative and customized solutions that cater to the unique needs of businesses across different industries. With our team of experts and our commitment to excellence, we help businesses optimize operations, increase efficiency, and generate valuable insights.</p>
                        <div class="row g-3">
                            <div class="col-sm-6">
                        ...
                        <div class="d-flex align-items-center mt-4">
                            ...
                            <a class="btn btn-outline-primary btn-square" href="https://www.linkedin.com/company/Patakhar/"><i class="fab fa-linkedin-in"></i></a> 
                        </div>
                    </div>
                    <div class="col-lg-6">
