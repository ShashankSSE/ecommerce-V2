            ...
            <div class="col-sm-12 py-5">
                ...
                <div class="content">
                    <ol class="liLists py-2">
                        ...
                        <li>"Service” refers to a service that 99Mentor provides, for a fee or gratis. You are using our Service when you actively sign up or sign in to get access to any Service provided by us.</li>
                        <li>"we”, “us”, “our”, and “99Mentor” refer to 99Mentor.</li>
                        <li>"Website” refers to 99Mentor website. You are using our “website” when you are visiting our website</li>
            ...
            <div class="col-sm-12 py-5">
                ...
                <div class="content">
                    <ol class="liLists py-2 noPoints">
                        <li>99mentor is a Product of JSPARK offered to our clients in Customized Mode.</li>
                    ...
                    <ol class="liLists py-2">
                        ...
                        <li>by email: on support@99mentor.com;</li>
                        <li>by telephone: on the contact number published on our Website from time to time;</li>
                        <li>by Website: by using our website contact form by <a href="http://99mentor.com/contact">Click Here</a></li>
